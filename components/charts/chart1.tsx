...
export default function Chart1() {
  return (
    <div className="h-[368px] shrink-0 lg:basis-[281.75px] basis-full  grow  rounded-[8px] p-[16px] [box-shadow:_0px_2px_4px_0px_rgba(0,_0,_0,_0.14),_0px_0px_2px_0px_rgba(0,_0,_0,_0.12);]">
